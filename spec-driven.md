...
/brief.specify Real-time chat system with message history and user presence
...
/brief.plan WebSocket for real-time messaging, PostgreSQL for history, Redis for presence
