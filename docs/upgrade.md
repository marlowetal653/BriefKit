...
> You have Brief installed and want to upgrade to the latest version to get new features, bug fixes, or updated slash commands. This guide covers both upgrading the CLI tool and updating your project files.
...
When Brief releases new features (like new slash commands or updated templates), you need to refresh your project's Brief files.
...
The `--no-git` flag tells Brief to **skip git repository initialization**. This is useful when:
...
This tells Brief which feature directory to use when creating specs, plans, and tasks.

**Why this matters:** Without git, Brief can't detect your current branch name to determine the active feature. The environment variable provides that context manually.
...
- Any other files not part of Brief templates
...
- ✅ **Expected** when upgrading an existing Brief project
...
Brief follows semantic versioning for major releases. The CLI and project files are designed to be compatible within the same major version.
...
- **Test new slash commands:** Run `/brief.constitution` or another command to verify everything works
- **Review release notes:** Check [GitHub Releases](https://github.com/github/brief/releases) for new features and breaking changes
- **Update workflows:** If new commands were added, update your team's development workflows
- **Check documentation:** Visit [github.io/brief](https://github.github.io/brief/) for updated guides
